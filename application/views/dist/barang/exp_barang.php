...
?>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Input Data Expired</h1>
          </div>
          

          <div class="section-body">
          <?php //print_r($barang); 
          $act = base_url()."C_barang/post_exp";
         ...
         foreach ($barang as $row){
            $form .= "<label for='" . $row["nama_barang"] . "'>" . $row["nama_barang"] . "</label> <input type='date' class='form-control col-lg-3' name='" . $row["id_barang"] . "' >";
        }
      ...
      foreach ($barang_komp as $row_komp){
        $form .= "<label for='" . $row_komp["nama_barang_komp"] . "'>" . $row_komp["nama_barang_komp"] . "</label> <input type='date' class='form-control col-lg-3' name='" . $row_komp["kode_barang_komp"] . "' >";
    }
